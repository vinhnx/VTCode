...
echo "  • Optional user notifications (configurable in vtcode.toml)"
echo ""
echo "To test manually:"
echo "  1. Run: ./target/release/vtcode"
echo "  2. Send 20+ messages"
echo "  3. Context will be automatically optimized (message hidden by default)"
echo "  4. Enable show_context_optimization_message in vtcode.toml to see notifications"
echo ""
