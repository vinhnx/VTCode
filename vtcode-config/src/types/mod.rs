...
/// Editing mode for agent startup (Codex-inspired workflow)
///
/// Used by the startup/session mode UI. Persistent startup behavior is configured
/// through `permissions.default_mode` in vtcode.toml.
///
