...
pub const CHAT_INPUT_PLACEHOLDER_BOOTSTRAP: &str = "Type a request… @files /commands • Tab agent • Ctrl+M model • Alt+P suggest • Shift+Tab mode • Enter queue • Ctrl+Enter run now • /stop stop task";
pub const CHAT_INPUT_PLACEHOLDER_FOLLOW_UP: &str = "Continue… @files /commands • Tab agent • Ctrl+M model • Alt+P suggest • Shift+Tab mode • Enter queue • Ctrl+Enter run now • /stop stop task";
