...
impl McpProvider {
    ...
    async fn refresh_tools(
        ...
        let tools = self.client.list_tools(params, timeout).await?;
    ...
    async fn call_tool(
        ...
        let params = CallToolRequestParams {
            ...
            arguments: McpClient::normalize_arguments(args),
        };
...
impl RmcpClient {
    ...
    async fn list_tools(
        ...
        let rmcp_params = params
            .map(|p| convert_to_rmcp::<_, rmcp::model::PaginatedRequestParam>(p))
            .transpose()?;
