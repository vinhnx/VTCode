...
pub const BUILTIN_BLOCKED_DOMAINS: &[&str] = &[
    // Banking & Financial
    "paypal.com", "stripe.com", "square.com", "interac.ca", "wire.com",
    // Authentication & Identity
    "github.com/login", "gitlab.com/users/login", "okta.com", "auth0.com",
    "accounts.google.com", "login.microsoftonline.com", "login.apple.com",
    // Email providers
    "mail.google.com", "outlook.live.com", "icloud.com/mail",
    // Personal/Private services
    "myfitnesspal.com", "health.apple.com", "health.google.com",
    // VPN & Proxy services
    "expressvpn.com", "nordvpn.com",
    // Medical & Health records
    "healthvault.com", "epic.com", "cerner.com",
    // Legal documents
    "docusign.com", "adobe.com/sign",
];

/// Built-in blocked patterns (used in restricted mode)
pub const BUILTIN_BLOCKED_PATTERNS: &[&str] = &[
    "password=", "token=", "api_key=", "secret=", "auth=", "session=", "cookie=",
    "oauth", "bearer%20", "x-auth", "authorization:",
    "/admin", "/private", "/internal", "/secret",
];
