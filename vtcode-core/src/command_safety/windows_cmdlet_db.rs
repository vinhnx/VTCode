...
pub static DANGEROUS_CMDLETS: Lazy<HashMap<&'static str, CmdletInfo>> = Lazy::new(|| {
    let mut m = HashMap::new();
        ...
        m.insert("invoke-command", CmdletInfo {
            name: "Invoke-Command",
            severity: CmdletSeverity::Critical,
            category: CmdletCategory::CodeExecution,
        ...
        m.insert("new-service", CmdletInfo {
            name: "New-Service",
            severity: CmdletSeverity::Critical,
        ...
        m.insert("remove-item", CmdletInfo {
            name: "Remove-Item",
            severity: CmdletSeverity::Critical,
        ...
        m.insert("stop-process", CmdletInfo {
            name: "Stop-Process",
            severity: CmdletSeverity::Critical,
        ...
        m.insert("get-wmiobject", CmdletInfo {
            name: "Get-WmiObject",
        ...
        m.insert("invoke-wmimethod", CmdletInfo {
        ...
        m.insert("new-psdrive", CmdletInfo {
            name: "New-PSDrive",
            severity: CmdletSeverity::High,
            category: CmdletCategory::FileOperations,
        ...
        m.insert("set-executionpolicy", CmdletInfo {
        ...
        m.insert("invoke-webrequest", CmdletInfo {
        ...
        m.insert("start-process", CmdletInfo {
            name: "Start-Process",
            severity: CmdletSeverity::High,
            category: CmdletCategory::ProcessManagement,
        ...
        m.insert("enable-psremoting", CmdletInfo {
        ...
        m.insert("new-itemproperty", CmdletInfo {
        ...
        m.insert("set-itemproperty", CmdletInfo {
        ...
        m.insert("remove-itemproperty", CmdletInfo {
        ...
        m.insert("get-process", CmdletInfo {
            name: "Get-Process",
            severity: CmdletSeverity::Medium,
            category: CmdletCategory::ProcessManagement,
        ...
        m.insert("get-service", CmdletInfo {
            name: "Get-Service",
            severity: CmdletSeverity::Medium,
            category: CmdletCategory::SystemManagement,
        ...
        m.insert("set-service", CmdletInfo {
            name: "Set-Service",
            severity: CmdletSeverity::Medium,
            category: CmdletCategory::SystemManagement,
        ...
        m.insert("restart-service", CmdletInfo {
        ...
        m.insert("write-host", CmdletInfo {
            name: "Write-Host",
        ...
        m.insert("get-credential", CmdletInfo {
            name: "Get-Credential",
            severity: CmdletSeverity::Medium,
        ...
        m.insert("convertto-securestring", CmdletInfo {
        ...
        m.insert("convertfrom-securestring", CmdletInfo {
        ...
        m.insert("get-member", CmdletInfo {
            name: "Get-Member",
            severity: CmdletSeverity::Medium,
        ...
        m.insert("[reflection.assembly]", CmdletInfo {
        ...
        m.insert("get-childitem", CmdletInfo {
            name: "Get-ChildItem",
            severity: CmdletSeverity::Low,
            category: CmdletCategory::FileOperations,
        ...
        m.insert("get-content", CmdletInfo {
            name: "Get-Content",
            severity: CmdletSeverity::Low,
            category: CmdletCategory::FileOperations,
        ...
        m.insert("get-itemproperty", CmdletInfo {
