...
impl TemplateEngine {
    ...
    fn create_traditional_template() -> SkillTemplate {
        SkillTemplate {
            ...
            file_structure: FileStructure {
                ...
                files: HashMap::from([
                    ("SKILL.md".to_string(), include_str!("../../templates/traditional/SKILL.md.template").to_string()),
                    ("README.md".to_string(), include_str!("../../templates/traditional/README.md.template").to_string()),
                ]),
                executables: HashMap::from([
                    ("scripts/helper.py".to_string(), include_str!("../../templates/traditional/scripts/helper.py.template").to_string()),
                ]),
            },
    ...
    fn create_cli_tool_template() -> SkillTemplate {
        SkillTemplate {
            ...
            file_structure: FileStructure {
                ...
                executables: HashMap::from([
                    ("tool.sh".to_string(), include_str!("../../templates/cli-tool/tool.sh.template").to_string()),
                ]),
            },
            default_metadata: HashMap::from([
    ...
    pub fn generate_skill(
        ...
        let skill_name = variables.get("skill_name")
        ...
        info!("Generating skill '{}' from template '{}' in {}", 
              skill_name, template_name, skill_dir.display());
    ...
    fn generate_skill_md(&self, template: &SkillTemplate, variables: &HashMap<String, String>) -> Result<String> {
        ...
        let description = variables.get("description")
