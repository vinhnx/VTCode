...
- **File**: `docs/project/TODO.md`
  - **Content**: Tighten Direct-Command and Test-Failure Recovery
  - **Topics**: Summary, Key Changes, Test Plan, Assumptions
  - **User Questions**: "What can you tell me about Tighten Direct-Command and Test-Failure Recovery?", "How does Summary work?", "How does Key Changes work?"
