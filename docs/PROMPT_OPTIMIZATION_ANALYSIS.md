...
|---------|--------|-----|--------|-------|
| IMPORTANT keyword |   Excellent |  Moderate |  Moderate | Use sparingly, with emphasis markers |
| XML tags |   Excellent |   Good |   Good | Use for structure |
| Markdown headers |   Excellent |   Excellent |   Excellent | Preferred |
| Nested conditionals |  Works |  Works |   Weak | Keep <3 levels |
...
| Long instructions |   Excellent (200K) |  Good (128K) |   Good | Compress for GPT |
