...
| Time provider | ⏸ Disabled | P2 | Enable in .mcp.json if needed for time-aware tasks |
| Sequential-thinking provider | ⏸ Not enabled | P2 | Configure in .mcp.json if complex reasoning needed |
