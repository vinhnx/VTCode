...
Enhanced streaming timeout error handling and added configurable streaming-specific timeout settings to VT Code.
...
-   The configuration takes effect immediately after restarting VT Code
