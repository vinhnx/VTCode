...
| Latest targeted revalidation | 2026-05-16 (TUI section + legibility tooling) |
...
**Related debt**: TD-005 (open)

| Dimension        | Grade | Evidence / Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Test Coverage    | B+    | Inline event-loop mapping still has focused regressions for key actions (`LaunchEditor`, `ToggleMode`, plan confirmation, interrupt exit) in `src/agent/runloop/unified/inline_events/tests.rs`, and helper behavior now has focused coverage in both `src/agent/runloop/unified/turn/session/interaction_loop_runner/support.rs` and `src/agent/runloop/unified/turn/session_loop_runner/support.rs`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| API Stability    | B     | Event loop and keybinding behavior are stable.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Agent Legibility | B     | The TUI roots now advertise entrypoints, constraints, and verify commands in-code, `unified/session_setup/ui.rs` dropped to 904 lines after extracting `ui/local_agents.rs`, `ui/persistent_memory.rs`, and `ui/tests.rs`, `turn/context.rs` dropped to 899 lines after extracting `context/continuation.rs`, `context/message_history.rs`, and `context/tests.rs`, `turn/tool_outcomes/execution_result.rs` dropped to 441 lines after extracting `execution_result/auto_mode_probe.rs`, `execution_result/failure_path.rs`, and `execution_result/tests.rs`, `slash_commands/diagnostics/memory.rs` dropped to 515 lines after extracting `memory/config_persistence.rs`, `memory/prompts.rs`, and `memory/presentation.rs`, `turn/turn_processing/plan_mode.rs` dropped to 567 lines after extracting `plan_mode/interview_context.rs` and `plan_mode/interview_payload.rs`, `turn/turn_loop.rs` dropped to 853 lines after extracting `turn_loop/usage_accounting.rs`, `turn_loop/post_tool_recovery.rs`, `turn_loop/notifications.rs`, and `turn_loop/tests.rs`, `share_log/timeline.rs` dropped to 603 lines after extracting `timeline/presentation.rs`, `turn_processing/llm_request/mod.rs` dropped to 682 lines after extracting `llm_request/tests.rs`, and `tool_outcomes/handlers/tests.rs` dropped to 333 lines after extracting `handlers/tests/basic.rs`, `handlers/tests/fallbacks.rs`, and `handlers/tests/runtime.rs`. `scripts/check_agent_legibility.py` now reports zero delegation gaps across the tracked hotspot roots, and the tracked TD-005 hotspot set is fully below 1,000 lines. |
...
**Overall: B**
**Priority action**: revisit any newly surfaced 900+ line roots outside the tracked TD-005 set while adding higher-level integration tests that exercise full inline loop interactions with modal flows and queue editing.
**Verify**: `find src -name '*.rs' -type f -exec wc -l {} + | sort -nr | head -n 20 && python3 scripts/check_agent_legibility.py --mode warn && cargo test -p vtcode --bin vtcode inline_events::tests`
