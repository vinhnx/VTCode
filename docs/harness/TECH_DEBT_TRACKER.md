...
| TD-004 | Features       | Subagent and agent-team surfaces were removed from runtime/config/docs. Keep deprecated references out of future docs and examples. | P2 | resolved | 2026-03-02 | Completed hard-removal cleanup across tooling, slash UX, config, and docs. |
