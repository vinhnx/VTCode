...
|--------|----------------|-------------|----------|--------|---------------|-------|
| TD-001 | Documentation  | Documentation sprawl: 600+ files in `docs/`, many stale or redundant. See `QUALITY_SCORE.md` Documentation domain (grade C). | P1 | in-progress | 2026-02-16 | Meta-docs (AGENTS.md, CONTRIBUTING.md) added. Consolidation ongoing; docs count was 666 at 2026-02-16 review. |
