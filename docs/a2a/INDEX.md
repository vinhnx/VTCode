...
-   [VT Code Main Architecture](../ARCHITECTURE.md)
-   [VT Code Contributing Guide](../../docs/CONTRIBUTING.md)
...
**Start Reading**: Begin with [README.md](README.md) for a comprehensive introduction to the A2A Protocol implementation in VT Code.
