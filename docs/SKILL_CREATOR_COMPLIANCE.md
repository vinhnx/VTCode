# Skill Authoring Implementation - Reference Compliance

## Overview

VT Code's skill authoring system is **fully compliant** with the industry-standard skill-creator reference implementation.
...
-   **Naming rules**: Lowercase alphanumeric + hyphens only, no reserved words
