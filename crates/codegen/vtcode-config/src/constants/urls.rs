...
pub(crate) const MIMO_TOKEN_PLAN_API_BASE: &str = "https://token-plan-ams.xiaomimimo.com/v1";
...
pub const QWEN_API_BASE: &str = "https://dashscope.aliyuncs.com/compatible-mode/v1";
