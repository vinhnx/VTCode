...
fn test_model_string_conversion() {
    // Gemini models
    assert_eq!(ModelId::Gemini35Flash.as_str(), models::google::GEMINI_3_5_FLASH);
    assert_eq!(ModelId::Gemini31ProPreview.as_str(), models::google::GEMINI_3_1_PRO_PREVIEW);
    // OpenAI models
    ...
    assert_eq!(ModelId::OpenCodeGoMinimaxM27.as_str(), models::opencode_go::MINIMAX_M2_7);
}
...
fn test_moonshot_and_openrouter_minimax_variants() {
    assert_eq!(models::moonshot::KIMI_K2_6.parse::<ModelId>().unwrap(), ModelId::MoonshotKimiK26);
