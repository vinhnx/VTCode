...
static REGISTRY: Lazy<HashMap<&'static str, ThemeDefinition>> = Lazy::new(|| {
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x3A, 0x95, 0xD6),
                alert: RgbColor(0xE5, 0x67, 0x65),
                logo_accent: RgbColor(0x8B, 0x69, 0x00),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x20, 0x73, 0xAE),
                alert: RgbColor(0xD3, 0x30, 0x2D),
                logo_accent: RgbColor(0x8B, 0x69, 0x00),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x4A, 0x90, 0xD2),
                alert: RgbColor(0xE0, 0x65, 0x6A),
                logo_accent: RgbColor(0xAF, 0x86, 0x21),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x63, 0x99, 0x9B),
                alert: RgbColor(0xDE, 0x71, 0x6C),
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                foreground: RgbColor(0xA8, 0x99, 0x84),
                secondary_accent: RgbColor(0x58, 0x91, 0x94),
                alert: RgbColor(0xDB, 0x64, 0x5F),
                logo_accent: RgbColor(0xD7, 0x99, 0x21),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            label: "Gruvbox Light",
            palette: ThemePalette {
                primary_accent: RgbColor(0x78, 0x6C, 0x61),
                background: RgbColor(0xFB, 0xF4, 0xE8),
                foreground: RgbColor(0x78, 0x6C, 0x61),
                secondary_accent: RgbColor(0x3E, 0x78, 0x7A),
                alert: RgbColor(0x9D, 0x00, 0x06),
                logo_accent: RgbColor(0x98, 0x63, 0x11),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x3D, 0x76, 0x79),
                alert: RgbColor(0x9D, 0x00, 0x06),
                logo_accent: RgbColor(0x98, 0x63, 0x11),
            },
        },
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x49, 0x75, 0x59),
                alert: RgbColor(0xB7, 0x46, 0x46),
                logo_accent: RgbColor(0x97, 0x5F, 0x08),
            },
        },
    );
    map.insert(
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                alert: RgbColor(0xD5, 0x39, 0x48),
                logo_accent: RgbColor(0x90, 0x70, 0x00),
            },
        },
    );
    map.insert(
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x3E, 0x70, 0xC3),
                alert: RgbColor(0xC2, 0x49, 0x3E),
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x41, 0x7A, 0xA2),
                alert: RgbColor(0xC8, 0x28, 0x29),
                logo_accent: RgbColor(0x99, 0x6C, 0x03),
            },
        },
    );
    map.insert(
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x68, 0x9A, 0xCD),
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x9B, 0xB3, 0x8E),
                alert: RgbColor(0xD2, 0x9F, 0x9F),
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x77, 0x97, 0xBC),
                alert: RgbColor(0xCE, 0x7D, 0x7B),
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x7F, 0x9C, 0xB9),
                alert: RgbColor(0xC2, 0x8C, 0x8C),
                logo_accent: RgbColor(0xB5, 0x93, 0x6A),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                logo_accent: RgbColor(0x85, 0x6B, 0x00),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x08, 0x6E, 0xD4),
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x08, 0x6E, 0xD4),
                alert: RgbColor(0xD1, 0x30, 0x27),
                logo_accent: RgbColor(0xA1, 0x5E, 0x00),
            },
        },
    );
    map.insert(
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                alert: RgbColor(0xA4, 0x55, 0x55),
                logo_accent: RgbColor(0x97, 0x60, 0x00),
            },
        },
    );
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                foreground: RgbColor(0x39, 0x3A, 0x34),
                secondary_accent: RgbColor(0x1C, 0x6B, 0x48),
                alert: RgbColor(0xA8, 0x57, 0x57),
                logo_accent: RgbColor(0x9B, 0x63, 0x00),
            },
        },
    );
    map.insert(
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            palette: ThemePalette {
                ...
                secondary_accent: RgbColor(0x81, 0x62, 0xFF),
    ...
    map.insert(
        ...
        ThemeDefinition {
            ...
            label: "Nord Light",
            palette: ThemePalette {
                primary_accent: RgbColor(0x52, 0x6E, 0x91),
                background: RgbColor(0xEC, 0xEF, 0xF4),
                foreground: RgbColor(0x2E, 0x34, 0x40),
                secondary_accent: RgbColor(0x4C, 0x56, 0x6A),
                alert: RgbColor(0x9B, 0x56, 0x60),
                logo_accent: RgbColor(0x5D, 0x6E, 0x55),
            },
        },
    );
