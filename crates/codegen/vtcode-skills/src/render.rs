...
fn render_skill_line(skill: &SkillMetadata) -> String {
    ...
    let scope = match skill.scope {
        crate::model::SkillScope::User => "user",
        crate::model::SkillScope::Repo => "repo",
        crate::model::SkillScope::System => "system",
        crate::model::SkillScope::Admin => "admin",
    };
...
mod tests {
    ...
    fn test_render_skills_section_single() {
        let skill = SkillMetadata {
            ...
            scope: crate::model::SkillScope::User,
            manifest: None,
        };
    ...
    fn test_render_skills_section_multiple() {
        ...
        let skill2 = SkillMetadata {
            ...
            scope: crate::model::SkillScope::Repo,
            manifest: None,
        };
    ...
    fn test_render_prompt_skills_section_hides_command_skills() {
        let hidden_skill = SkillMetadata {
            ...
            scope: crate::model::SkillScope::System,
            manifest: Some(
