...
To help you get started with VTCode configuration, we provide these example files:
...
You can copy either of these files to your project root to begin customizing your VTCode experience.
