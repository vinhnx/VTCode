# VT Code Extension Architecture
...
VT Code VSCode extension follows a modular, plugin-like architecture designed for extensibility, testability, and maintainability. The architecture separates concerns into distinct layers: Command System, Participant System, State Management, and Core Services.
...
-   **CLI integration**: Spawns VT Code CLI processes
...
-   [VT Code CLI Documentation](https://github.com/vinhnx/vtcode)
-   [VT Code Configuration Guide](./config.md)

---

**Document Version**: 2.0
**Last Updated**: November 8, 2025
**Maintained By**: VT Code Development Team
