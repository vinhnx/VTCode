...
const ERROR_MESSAGES: Record<string, ErrorMessage> = {
    ...
    NETWORK_TIMEOUT: {
        ...
        suggestion:
            "Try again. If the problem persists, check your internet connection.",
        retryable: true,
    },
    NETWORK_ERROR: {
        title: "Network connection error",
        description:
            "Unable to connect to the AI service. Check your internet connection and try again.",
    ...
    RATE_LIMITED: {
        ...
        description:
            "Too many requests have been sent. The service is temporarily throttling requests.",
        suggestion:
            "Wait a moment and try again. Consider spacing out requests.",
        retryable: true,
    },
    INVALID_API_KEY: {
        ...
        suggestion:
            "Check your VT Code configuration and verify the API key is correct. See the troubleshooting guide.",
    ...
    MODEL_OVERLOADED: {
        ...
        suggestion:
            "Try again in a few moments. Use a faster model if available.",
        retryable: true,
    },
    ...
    CONTEXT_TOO_LARGE: {
        ...
        description:
            "The combined input is too large for the model to process.",
        suggestion:
            "Remove some files or messages from the context and try again.",
        retryable: true,
    },
    ...
    TOOL_EXECUTION_FAILED: {
        ...
        suggestion:
            "Check the tool output for details. Some tools may require specific workspace setup.",
        retryable: true,
    },
    TOOL_NOT_FOUND: {
        title: "Tool not available",
        description:
            "The requested tool is not installed or not available in this context.",
        suggestion:
            "Verify the tool is properly configured in your VT Code setup.",
    },
    TOOL_PERMISSION_DENIED: {
        title: "Tool execution denied",
        description:
            "You need to approve this tool execution for security reasons.",
    ...
    WORKSPACE_NOT_TRUSTED: {
        ...
        description:
            "The workspace must be trusted to execute certain operations.",
        suggestion:
            "Click 'Trust Workspace' in VS Code to enable full functionality.",
    },
    FILE_NOT_FOUND: {
    ...
    WORKSPACE_ERROR: {
        ...
        suggestion:
            "Check that the workspace is properly configured and files are accessible.",
        retryable: true,
    },
    ...
    CONFIG_ERROR: {
        ...
        description: "The VT Code configuration contains invalid settings.",
    ...
    INVALID_MODEL: {
        ...
        suggestion:
            "Check your model configuration and select an available model.",
    ...
    OUT_OF_MEMORY: {
        ...
        suggestion:
            "Close some files or reduce the context size. Consider restarting VS Code.",
    },
    ...
    MCP_SERVER_ERROR: {
        ...
        description:
            "The MCP server encountered an error or is not responding.",
        suggestion:
            "Check that the MCP server is running and properly configured.",
        retryable: true,
    },
    MCP_DISCONNECTED: {
        ...
        suggestion:
            "The connection will be re-established automatically. If the problem persists, restart the MCP server.",
        retryable: true,
    },
};
