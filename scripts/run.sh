...
echo "=================================================="
echo "Tip: Store API keys securely with 'vtcode secret add <provider>' or '/secret add' in the TUI."
echo "     Shell exports and workspace .env still work if you prefer them."
