...
pub const INLINE_INPUT_STATUS_HEIGHT: u16 = 1;
...
pub const INLINE_LIST_MAX_ROWS: usize = 10;
pub const INLINE_LIST_MAX_ROWS_MULTILINE: usize = 20;
...
pub const CHAT_INPUT_PLACEHOLDER_BOOTSTRAP: &str = "Type your message, or @files, /commands, Alt+P: suggest, Shift+Tab: choose Edit/Trusted Auto/Plan, Enter: queue, Tab: accept/queue, Ctrl+Enter: run/steer now, /stop: stop task";
pub const CHAT_INPUT_PLACEHOLDER_FOLLOW_UP: &str = "Continue, or @files, /commands, Alt+P: suggest, Shift+Tab: choose Edit/Trusted Auto/Plan, Enter: queue, Tab: accept/queue, Ctrl+Enter: run/steer now, /stop: stop task";
...
pub const THEME_PTY_OUTPUT_LIGHTEN_RATIO: f64 = 0.12;
