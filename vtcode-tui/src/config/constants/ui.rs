...
pub const CHAT_INPUT_PLACEHOLDER_BOOTSTRAP: &str = "Type your message, or @files, /commands, Shift+Tab: cycle Edit/Trusted Auto/Plan, Enter/Tab: queue, Ctrl+Enter: run/steer now, /stop: stop task";
pub const CHAT_INPUT_PLACEHOLDER_FOLLOW_UP: &str = "Continue, or @files, /commands, Shift+Tab: cycle Edit/Trusted Auto/Plan, Enter/Tab: queue, Ctrl+Enter: run/steer now, /stop: stop task";
