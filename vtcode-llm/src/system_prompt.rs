...
/// Default GPT-5.6 contract addendum appended to system prompts for GPT-5.6 models.
/// Incorporates GPT-5.6-specific prompting guidance from OpenAI's developer documentation.
...
/// Get the OpenAI GPT-5.6 contract addendum.
///
/// Returns the addendum set via [`set_openai_gpt56_addendum`] if available,
/// otherwise falls back to a built-in default.
...
/// Override the OpenAI GPT-5.6 addendum (called by vtcode-core at init).
