# VT Code Zed Extension - Release Notes v0.3.0
...
VT Code Zed Extension v0.3.0 is a complete, production-ready implementation of the VT Code AI coding assistant for the Zed editor. This release includes all core features, advanced integrations, error handling, and performance optimizations.
