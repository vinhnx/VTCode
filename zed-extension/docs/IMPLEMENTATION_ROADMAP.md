# VT Code Zed Extension - Implementation Roadmap
...
**Goal**: Enable VT Code CLI command execution from Zed
...
-   `src/executor.rs` - VT Code CLI command execution
...
**Goal**: Expose VT Code commands through Zed's command palette
...
**Goal**: Display VT Code responses in editor
...
**Goal**: Pass richer context to VT Code agent
...
-   [VS Code VT Code Extension](../vscode-extension)
-   [VT Code CLI Repository](https://github.com/vinhnx/vtcode)
...
-   All heavy computation is delegated to VT Code CLI
...
1. **Process Execution** - VT Code CLI integration with full command execution
